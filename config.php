...
$empfaenger = "info@ags-engineering.de";  // Ihre E-Mail Adresse (zwischen den Anführungszeichen) Bei Problemen: https://www.kontaktformular.com/faq-script-php-kontakt-formular.html#keine-mail-erhalten

$ihrname = "Stefano Giuliana";  // Ihr Name (zwischen den Anführungszeichen)
...
$cfg['Loading_Spinner'] = 1;  //  0 = Ohne Loading Spinner im Senden-Button    1 = Mit Loading Spinner im Senden-Button
...
$cfg['Links'] = 0;  //  Anzahl der maximal erlaubten Links (0 = keine Links erlaubt)
